...
public class SharedResourcesIntegrationTestsSupport {
  ...
  public static void apply(@NotNull final BuildServerCreator fixture) {
    ...
    final LocksStorage locksStorage = new CDSBasedTakenLocksStorage(fixture.getProjectManager(),
                                                                    fixture.getBuildPromotionManager(),
                                                                    fixture.getBuildsManager(),
    ...
    FeatureParamsImpl featureParams = new FeatureParamsImpl(locks);
    fixture.addService(featureParams);

    fixture.getServer().registerExtension(BuildFeature.class, SharedResourcesBuildFeature.class.getName(), new SharedResourcesBuildFeature(descriptor, featureParams));
